...
#ifndef CIRCLESCAREEXPOBROWNFIELD_SWIFT_H
#define CIRCLESCAREEXPOBROWNFIELD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="circlescareexpobrownfield",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25circlescareexpobrownfield25ExpoBrownfieldAppDelegate")
...
@class NSCoder;
@class NSBundle;
SWIFT_CLASS("_TtC25circlescareexpobrownfield25ReactNativeViewController")
